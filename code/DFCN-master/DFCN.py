'''
Author: xinying Lai
Date: 2022-09-12 22:13:28
LastEditTime: 2022-09-13 10:18:54
...
class DFCN(nn.Module):
    ...
    def __init__(self, ae_n_enc_1, ae_n_enc_2, ae_n_enc_3,
        ...
        self.device = device
        if n_node is None:
            self.a = Parameter(nn.init.constant_(torch.zeros(1), 0.5), requires_grad=True).to(self.device)
        else:
